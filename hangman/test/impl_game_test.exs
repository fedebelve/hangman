defmodule HangmanImplGameTest do
  ...
  test "all letters lower case" do
    game = Game.new_game("wombat")

    result = Enum.all?(game.letters , fn x -> String.match?(x, ~r/^[[:lower:]]+$/) end)
    assert true = result
  end
  ...
  test "we record letters used" do
    ...
    #assert MapSet.size((game.used)) == 2
  ...
  #hello
  test "can gandle a sequence of move -> WIN " do
  [
  ...
  #hello
  test "can gandle a sequence of move -> LOST" do
    [
      #guess | state    turns letters       used
      [ "a", :bad_guess, 6, ["_", "_", "_", "_", "_"], ["a"]],
      [ "a", :already_used, 6, ["_", "_", "_", "_", "_"], ["a"]],
      [ "w", :bad_guess, 5, ["_", "_", "_", "_", "_"], ["a", "w"]],
      [ "p", :bad_guess, 4, ["_", "_", "_", "_", "_"], ["a", "p", "w"]],
      [ "m", :bad_guess, 3, ["_", "_", "_", "_", "_"], ["a", "m", "p", "w"]],
      [ "n", :bad_guess, 2, ["_", "_", "_", "_", "_"], ["a", "m", "n", "p", "w"]],
      [ "x", :bad_guess, 1, ["_", "_", "_", "_", "_"], ["a", "m", "n", "p", "w", "x"]],
      [ "r", :lost, 0, ["_", "_", "_", "_", "_"],      ["a", "m", "n", "p", "r", "w", "x"]],
    ]
    |> test_sequence_of_moves()
